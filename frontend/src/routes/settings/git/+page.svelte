					...
					<div class="flex items-start justify-between">
						...
						<div class="flex items-center gap-2">
							<span
								...
								{repo.is_active ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200'}"
							>

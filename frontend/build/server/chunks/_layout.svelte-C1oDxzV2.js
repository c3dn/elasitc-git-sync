import { a8 as ensure_array_like, a9 as attr, aa as attr_class, ab as stringify, a6 as store_get, a7 as slot, ac as unsubscribe_stores, ae as sanitize_props, af as spread_props } from './index2-uIxG4uRE.js';
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="space-y-6"><div><h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Settings</h1> <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Configure Elastic instances, Git repositories, webhooks, and your account</p></div> <div class="border-b border-gray-200 dark:border-gray-700"><nav class="flex gap-8"><!--[-->`);
...
//# sourceMappingURL=_layout.svelte-C1oDxzV2.js.map

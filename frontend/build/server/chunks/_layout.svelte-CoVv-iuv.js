import { a6 as store_get, a7 as slot, a8 as ensure_array_like, a9 as attr, aa as attr_class, ab as stringify, ac as unsubscribe_stores, ad as bind_props, ae as sanitize_props, af as spread_props } from './index2-DXgNDLRr.js';
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (isLoginPage) {
      ...
      $$renderer2.push(`<!----> Sign Out</button></div> <div class="px-6 py-3 border-t border-gray-200"><p class="text-xs text-gray-500">Version 1.0.0</p> <p class="text-xs text-gray-400 mt-1">By Cedric Selkmann</p></div></div></div> <div class="ml-64"><main class="p-8"><!--[-->`);
      slot($$renderer2, $$props, "default", {});
...
//# sourceMappingURL=_layout.svelte-CoVv-iuv.js.map

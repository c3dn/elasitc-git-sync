import { ag as head, a8 as ensure_array_like, aa as attr_class, ab as stringify } from './index2-DXgNDLRr.js';
import './pocketbase-BRYPPp6T.js';
import { P as Plus } from './plus-DtRXhZbX.js';
import { C as Circle_check_big, a as Circle_x, R as Refresh_cw, P as Pencil, T as Trash_2 } from './trash-2-BEy0NZNA.js';
  ...
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> `);
    {
      ...
      if (repositories.length === 0 && true) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center"><p class="text-gray-500">No Git repositories configured yet.</p></div>`);
      } else {
        $$renderer2.push("<!--[!-->");
        ...
        for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
          ...
          $$renderer2.push(`<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6"><div class="flex items-start justify-between"><div class="flex-1"><div class="flex items-center gap-3 mb-2"><h3 class="text-lg font-semibold text-gray-900">${escape_html(repo.name)}</h3> `);
          ...
          $$renderer2.push(`<!--]--> <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-800">${escape_html(repo.provider)}</span></div> <p class="text-sm text-gray-600 mb-1">${escape_html(repo.url)}</p> <p class="text-xs text-gray-500">Branch: ${escape_html(repo.default_branch)} `);
          if (repo.base_path) {
            $$renderer2.push("<!--[-->");
          ...
          $$renderer2.push(`<!--]--></p></div> <div class="flex items-center gap-2"><span${attr_class(`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${stringify(repo.is_active ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800")}`)}>${escape_html(repo.is_active ? "Active" : "Inactive")}</span></div></div> <div class="flex items-center gap-2 mt-4 pt-4 border-t border-gray-200"><button class="inline-flex items-center gap-2 px-3 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm">`);
...
//# sourceMappingURL=_page.svelte-BsH2n7kb.js.map

import { ag as head, a8 as ensure_array_like, aa as attr_class, a9 as attr, ae as sanitize_props, af as spread_props, a7 as slot, ab as stringify } from './index2-DXgNDLRr.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> `);
    {
      ...
      $$renderer2.push(`</textarea></div> <div><label class="block text-sm font-medium text-gray-700 mb-2">Sync Mode *</label> <div class="grid grid-cols-2 gap-3"><button type="button"${attr_class(`flex flex-col items-start p-4 border-2 rounded-lg transition-colors ${stringify(
...
//# sourceMappingURL=_page.svelte-BZmQUvsl.js.map

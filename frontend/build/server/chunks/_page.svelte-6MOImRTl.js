import { a6 as store_get, ag as head, ac as unsubscribe_stores } from './index2-uIxG4uRE.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="space-y-6"><div class="flex items-center justify-between animate-fade-in"><div><a href="/projects" class="inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 mb-2 transition-colors duration-200">`);
    ...
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Loading...</h1>`);
    }
    $$renderer2.push(`<!--]--></div> `);
    {
      $$renderer2.push("<!--[!-->");
...
//# sourceMappingURL=_page.svelte-6MOImRTl.js.map

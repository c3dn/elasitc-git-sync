  ...
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> `);
    {
      ...
      if (instances.length === 0 && true) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div class="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center"><p class="text-gray-500 dark:text-gray-400">No Elastic instances configured yet.</p></div>`);
      } else {
        $$renderer2.push("<!--[!-->");
        ...
        for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
          ...
          $$renderer2.push(`<!--]--></div> <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">${escape_html(instance.url)}</p> `);
          if (instance.spaces && instance.spaces.length > 0) {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<p class="text-xs text-gray-500 dark:text-gray-400">Spaces: ${escape_html(instance.spaces.join(", "))}</p>`);
          } else {
            $$renderer2.push("<!--[!-->");
          }
          $$renderer2.push(`<!--]--></div> <div class="flex items-center gap-2"><span${attr_class(`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${stringify(instance.is_active ? "bg-green-100 text-green-800" : "bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200")}`)}>${escape_html(instance.is_active ? "Active" : "Inactive")}</span></div></div> <div class="flex items-center gap-2 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700"><button class="inline-flex items-center gap-2 px-3 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-sm">`);
...
//# sourceMappingURL=_page.svelte-CRMDCOcO.js.map

...
import { w as writable, r as readable } from './chunks/index-BZCjIgoZ.js';
import { d as define_property, a as array_from, s as setContext } from './chunks/context-CXh5FE9f.js';
import 'clsx';
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./chunks/hooks.server-B0EOH0ql.js'));
  let reroute;
  let transport;
  return {
    handle,
